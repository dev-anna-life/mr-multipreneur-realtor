        ...
        <div className="max-w-7xl mx-auto px-6 py-8 md:py-10">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5 md:gap-8">
            <a href="tel:+2347048322531" className="flex items-center gap-2 md:gap-3 group">
              ...
              <div class="min-w-0"><div className="text-[10px] md:text-xs text-cream/40 uppercase tracking-wider">Phone</div><div className="text-xs md:text-sm font-semibold text-cream/90 group-hover:text-gold transition-colors break-all">+234 7048322531</div></div>
            </a>
            <a href="mailto:Eponixlimited@gmail.com" className="flex items-center gap-2 md:gap-3 group">
              ...
              <div class="min-w-0"><div className="text-[10px] md:text-xs text-cream/40 uppercase tracking-wider">Email</div><div className="text-xs md:text-sm font-semibold text-cream/90 group-hover:text-gold transition-colors break-all">Eponixlimited@gmail.com</div></div>
            </a>
            <div className="flex items-center gap-2 md:gap-3">
              ...
              <div class="min-w-0"><div className="text-[10px] md:text-xs text-cream/40 uppercase tracking-wider">Locations</div><div className="text-xs md:text-sm font-semibold text-cream/90">Asaba <span className="text-gold/40 mx-0.5">|</span> Anambra <span className="text-gold/40 mx-0.5">|</span> Enugu</div></div>
            </div>
            <a href="https://wa.me/2347048322531?text=Hello%20Harrison%2C%20I'd%20like%20to%20book%20a%20property%20inspection." target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 md:gap-3 group">
              ...
              <div class="min-w-0"><div className="text-[10px] md:text-xs text-cream/40 uppercase tracking-wider">WhatsApp</div><div className="text-xs md:text-sm font-semibold text-cream/90 group-hover:text-gold transition-colors">WhatsApp Us</div></div>
            </a>
          </div>
