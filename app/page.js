  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 bg-gold text-navy px-6 py-3 rounded-full font-bold text-sm shadow-lg hover:bg-gold-light hover:scale-105 transition-all duration-300 flex items-center gap-2 animate-float cursor-pointer"
