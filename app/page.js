    ...
    <>
      <nav className="fixed top-0 left-0 right-0 z-50 bg-navy/95 backdrop-blur-md border-b border-gold/10">
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-4 flex justify-between items-center">
          ...
          <div>
            <a href="#book-inspection" className="bg-gold text-navy px-3 md:px-5 py-1.5 md:py-2 rounded-full text-xs md:text-sm font-bold hover:bg-gold-light transition-all whitespace-nowrap">Book for Inspection</a>
          </div>
        </div>
      </nav>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto items-start">
              {investmentPlans.map((plan, i) => (
                <div key={i} className={`relative rounded-2xl p-8 border-2 transition-all duration-300 hover:-translate-y-2 hover:shadow-xl ${i === 1 ? 'border-gold bg-gold/5 md:scale-110' : 'border-gray-100 bg-white'}`}>
                  {plan.tag && (
      ...
      <footer className="bg-gradient-to-r from-navy via-navy/90 to-charcoal backdrop-blur-md border-t border-gold/10">
        <div className="max-w-7xl mx-auto px-6 py-8 md:py-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-8">
            <a href="tel:+2347048322531" className="flex items-center gap-3 group">
              <div className="w-9 h-9 rounded-full bg-gold/10 flex items-center justify-center text-gold group-hover:bg-gold group-hover:text-navy transition-all duration-300 shrink-0">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/></svg>
              </div>
              <div className="min-w-0"><div className="text-xs text-cream/40 uppercase tracking-wider">Phone</div><div className="text-sm font-semibold text-cream/90 group-hover:text-gold transition-colors">+234 7048322531</div></div>
            </a>
            <a href="mailto:Eponixlimited@gmail.com" className="flex items-center gap-3 group">
              ...
              <div className="min-w-0"><div className="text-xs text-cream/40 uppercase tracking-wider">Email</div><div className="text-sm font-semibold text-cream/90 group-hover:text-gold transition-colors">Eponixlimited@gmail.com</div></div>
            </a>
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0"><div className="text-xs text-cream/40 uppercase tracking-wider">Locations</div><div className="text-sm font-semibold text-cream/90">Asaba <span className="text-gold/40 mx-1">|</span> Anambra <span className="text-gold/40 mx-1">|</span> Enugu</div></div>
            </div>
            <a href="https://wa.me/2347048322531?text=Hello%20Harrison%2C%20I'd%20like%20to%20book%20a%20property%20inspection." target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 group">
              ...
              <div className="min-w-0"><div className="text-xs text-cream/40 uppercase tracking-wider">WhatsApp</div><div className="text-sm font-semibold text-cream/90 group-hover:text-gold transition-colors">WhatsApp Us</div></div>
            </a>
          </div>
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-50 bg-gold text-navy px-4 md:px-6 py-2.5 md:py-3 rounded-full font-bold text-xs md:text-sm shadow-lg hover:bg-gold-light hover:scale-105 transition-all duration-300 flex items-center gap-1.5 md:gap-2 animate-float cursor-pointer"
